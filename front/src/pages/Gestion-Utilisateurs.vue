	...
	<div class="body">
		...
		<div class="user-management">
			<div class="user-list">
				<form id="search-user">
					Rechercher
					<input v-model="searchQuery" placeholder="Entrer le prénom utilisateur" />
				</form>
				<GridComponent :heroes="filteredUsers" :columns="gridColumns" :filter-key="searchQuery" />
			</div>
			<div class="user-forms">
				...
				<form id="select-user" @submit.prevent="selectUserToEdit">
					<input v-model="editUserId" type="text" placeholder="ID utilisateur" />
					<button type="submit">Sélectionner</button>
				</form>
				<form id="edit-user" v-if="userToEdit" @submit.prevent="updateUser">
					<input v-model="userToEdit.firstName" type="text" placeholder="Prénom" />
					<input v-model="userToEdit.lastName" type="text" placeholder="Nom" />
					<input v-model="userToEdit.password" type="password" placeholder="Mot de passe" />
				...
				<form id="delete-user" @submit.prevent="deleteUser">
					<input v-model="deleteUserId" type="text" placeholder="ID utilisateur" />
